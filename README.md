...
The exact contract every vendor package and skill must satisfy is defined in [`docs/SKILL-FORMAT-SPEC.md`](./docs/SKILL-FORMAT-SPEC.md) — read that before adding a new vendor/skill or judging whether an existing one is "done."
