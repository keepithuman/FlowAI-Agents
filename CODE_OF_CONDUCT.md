...
This Code of Conduct sets expectations for behavior in the Network and Infrastructure Skills community. It ensures a respectful, safe, and inclusive environment for contributors, maintainers, users, and newcomers — regardless of background, skill level, or personal identity.
...
- Repeated or severe behavior can lead to bans from the project (GitHub issues, PRs, discussions).
- Reports will be reviewed by the maintainer(s).

## Reporting

If you experience or witness a violation, **speak up**:

- Open a private report via [GitHub's abuse/report tools](https://github.com/contact/report-abuse), or
- Contact the maintainer directly: [@keepithuman](https://github.com/keepithuman)
...
- Discussions
- Any communication representing the project elsewhere
